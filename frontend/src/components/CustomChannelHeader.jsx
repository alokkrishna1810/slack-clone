...
import { HashIcon, LockIcon, UserIcon, VideoIcon } from "lucide-react";
import { useState } from "react";
import { PinIcon, useChannelStateContext } from "stream-chat-react";
import MembersModal from "./MembersModal.jsx";
import PinnedMessageModal from "./PinnedMessageModal.jsx";
...
const CustomChannelHeader = () => {
  ...
  return (
    <div className="h-14 border-b border-gray-200 flex items-center px-4 justify-center bg-white">
